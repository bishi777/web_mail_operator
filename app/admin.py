...
class HappymailAdmin(admin.ModelAdmin):
    ...
    fields = [
        ...
        'self_promotion',
        'mail_address', 'gmail_password', 'mail_address_image',
...
class IkukuruAdmin(admin.ModelAdmin):
    ...
    fields = [
        'user_id', 'name', 'login_mail_address', 'password',  'post_title','post_content',
