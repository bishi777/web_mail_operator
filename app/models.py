...
class Happymail(models.Model):
  ...
  height_list = [
    ...
    ("160～164","160～164"), ("165～169","165～169"), 
    ("170～174","170～174"), ("175～179","175～179"),
    ("180～184","180～184"), ("185～","185～"),
    ("ナイショ", "ナイショ"), ("指定しない", "指定しない"),
  ]
  ...
  date_created = models.DateTimeField(date_created = models.DateTimeField(null=True, blank=True, verbose_name="作成日時")
